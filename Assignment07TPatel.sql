...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_TPatel')
	 Begin 
	  Alter Database [Assignment07DB_TPatel] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_TPatel;
	 End
	Create Database Assignment07DB_TPatel;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_TPatel;
